...
<div class="top-[calc(0.5rem+env(safe-area-inset-top))] flex w-full justify-center px-2 pointer-events-none fixed z-100">
	<div
	...
	>
		...
		<Button variant="ghost" size="" class="self-start rounded-sm p-2" onclick={() => closeToast()}>
			<X />
		</Button>
	</div>
</div>
