<script module lang="ts">
	...
	import BasicPokemonDisplayMultiple from "@/components/ui/popups2/common/BasicPokemonDisplayMultiple.svelte";
	import BasicPokemonDisplayOne from "@/components/ui/popups2/common/BasicPokemonDisplayOne.svelte";
	import {
		Candy,
		CircleAlert,
		CircleDot,
...
<script>
	...
	import { currentTimestamp } from "$lib/utils/currentTimestamp.ts";
	import { formatPercentage } from "$lib/utils/numberFormat.ts";
</script>
